...
def load_data(PATH_target, PATH_evaluation, target_model, evaluate_model, use_DP):
    '''	
    ...
    if use_DP:
        ...
        if not ModuleValidator.is_valid(evaluate_model):
            evaluate_model = ModuleValidator.fix(evaluate_model)
