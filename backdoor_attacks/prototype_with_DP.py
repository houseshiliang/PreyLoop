...
class NormalCase:
    ...
    def set_args(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument("--yaml_path", type=str, default="../backdoor_resource/config/attack/prototype/cifar10.yaml")
        ...
        # parser.add_argument('--save_folder_name', type=str, help='(Optional) should be time str + given unique identification str', default='badnet_0_1')
        parser.add_argument('--git_hash', type=str, help='git hash number, in order to find which version of code is used')
        
        parser.add_argument('--DP_type', type=str,  default='rdp')  # ac, rdp, gdp, prv,           zcdp
        parser.add_argument('--noise', type=float, default=1.0)  # sigma = noise
    ...
    def prepare(self, args):
        ...
        #         all_record_folder_path='../backdoor_resource/record',
        #     )
        # else:
        #     # save_path = '../backdoor_resource/record/' + args.save_folder_name
