...
from backdoor_attacks.badnet_with_DP import BadNet, add_common_attack_args
...
class SSBA(BadNet):
    ...
    def process_args(self, args):
        ...
        args.attack_train_replace_imgs_path = '../data/datasets/' + args.dataset + '_seperate_images/train_encode.npy'
        args.attack_test_replace_imgs_path = '../data/datasets/' + args.dataset + '_seperate_images/test_encode.npy'
