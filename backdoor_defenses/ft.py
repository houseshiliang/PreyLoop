...
class ft(defense):
    ...
    def add_arguments(parser):
        ...
        parser.add_argument('--yaml_path', type=str, default="../backdoor_resource/config/defense/ft/default.yaml", help='the path of yaml')
    ...
    def mitigation(self):
        ...
        model = generate_cls_model(self.args.model,
